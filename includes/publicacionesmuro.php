     ...
     <table width="400">
         ...
         <tr>
             <td align="right">
                 ...
                 <button type="submit" ><img src="img/publish.png" alt=""></button>
...
$ejcl=$conexion->query($cuantoslikes);
...
$ejcoment=$conexion->query($coment);
...
do{
	...
	<small><?php $date= $acoment['fecha']; $sqldate=date('d / M / Y ',strtotime($date));
			...
			<td align="right" width="40">
			<img src="../fotos/<?php echo $auser['email']."__".$auser['fotos'];?>" width="25" height="25">
			</td>
	<td valign="bottom" width="320">
	<form name="enviarcomentario" method="POST" action="pinicio.php">
	<textarea name="comen" cols=35 rows=1 placeholder="¿Qué estás pensando?"></textarea>
	    </td>
	    <td valign="bottom">
    ...
    <?php }while($tp=mysqli_fetch_assoc($ej)); ?>
        <tr>
